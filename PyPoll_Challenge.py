...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_names:
        ...
        county_results = (f"{county_name}: {percent_votes:.1f}% ({votes:,})\n")
        ...
        if largest_turnout_county == "":
            largest_turnout_county = county_name
        if largest_turnout == 0:
    ...
    largest_turnout_results = (
        f"\n-------------------------\n"
        f"{largest_turnout_county} County had the largest turnout with {largest_turnout:,} Voters!"
        f"\n-------------------------\n")
